...
class CourseOutlineTool(Tool):
    """Tool for retrieving course outline and structure information"""
    ...
    def execute(self, course_name: str) -> str:
        ...
        try:
            ...
            formatted = f"Course: {metadata.get('title', 'N/A')}\n"
            formatted += f"Course Link: {metadata.get('course_link', 'N/A')}\n"
            formatted += "Lessons:\n"
            ...
            if lessons_json:
                ...
                for lesson in lessons:
                    formatted += f"  {lesson.get('lesson_number', 'N/A')}. {lesson.get('lesson_title', 'N/A')}\n"
            else:
                formatted += "  No lessons available\n"
